...
public class CharaST {
    ...
    public void populate(boolean promoted, Data.UnitTemplate template, Data.WeaponType type, boolean east, Data.AnimUnitSSId id, TextureRegion[] spriteSet){
        populate(promoted, template, type, east, id, false, spriteSet);
    }

    public Array<Sprite> getSpriteSet(boolean promoted, Data.UnitTemplate template, Data.WeaponType type, Data.Orientation or, boolean done, Data.AnimUnitSSId id){
        ...
        if(tra == null) {
            ...
            if(id.isRest0()) spriteset.add(getSpriteSet(promoted, template, type, or, done, Data.AnimUnitSSId.REST).get(0));
            Sprite sprite;
            float spriteWidth;
    ...
    private Array<Sprite> getSpriteSet(boolean promoted, Data.Orientation or, boolean done, Data.AnimUnitSSId id) {
