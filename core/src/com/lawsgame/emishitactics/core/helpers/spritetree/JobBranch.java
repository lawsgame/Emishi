...
public class JobBranch {
    ...
    public void populate(Data.WeaponType type, boolean east, Data.SpriteSetId id, TextureRegion[] spriteSet, boolean done){
        for(int i = 0; i < children.size; i++){
            if(children.get(i).type == type){
    ...
    public TextureRegion[] getSpriteSet(Data.WeaponType type, Data.Orientation or, boolean done, Data.SpriteSetId id){
