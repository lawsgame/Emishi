...
public class ShieldedBranch {
    ...
    public TextureRegion[] getSpriteSet(boolean horseman, Data.UnitTemplate template, Data.WeaponType type, Data.Orientation or, boolean done, Data.SpriteSetId id){
