...
public class Data {
    ...
    public enum UnitTemplate {
        SOLAIRE(1, new Ability[]{Ability.HEAL}, false, false,
                4, 3, 3, 36, 9, 8, 5, 4, 6, 7, 3, 0, 2,
                1, 0, 2, 9,  1, 2, 2, 1, 1, 2, 2, 0, 3,
                0.00f, 0.15f, 0.40f, 0.60f, 0.40f, 0.15f, 0.15f, 0.15f, 0.40f, 0.40f, 0, 0.40f,
                0.00f, 0.20f, 0.50f, 0.70f, 0.50f, 0.20f, 0.20f, 0.20f, 0.50f, 0.50f, 0, 0.50f),
        SOLAR_KNIGHT(1, new Ability[]{Ability.GUARD}, false, false,
                4, 3, 3, 25, 5, 8, 5, 4, 6, 7, 3, 0, 2,
                1, 0, 2, 9,  1, 2, 2, 1, 1, 2, 2, 0, 3,
                0.00f, 0.15f, 0.40f, 0.60f, 0.40f, 0.15f, 0.15f, 0.15f, 0.40f, 0.40f, 0, 0.40f,
                0.00f, 0.20f, 0.50f, 0.70f, 0.50f, 0.20f, 0.20f, 0.20f, 0.50f, 0.50f, 0, 0.50f);
